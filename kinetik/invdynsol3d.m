function [Fprox, Mprox, Finert, Minert] = invdynsol3d(segm, kinem, forces)
  
%   [Fprox, Mprox] = invdynsol3d(segm, kinem, forces)
%
% Solves the 3d inverse dynamics problem. The reference frame
% considered is fixed in the segment with the origin coinciding
% with the proximal joint center and the z-axis pointing towards
...
%                                  of mass. 
%                ang_acc       ->  The angular accelleration vector
...
%                                  (3 x n) matrix where each column contains
%                                  the application point of the force vector.
