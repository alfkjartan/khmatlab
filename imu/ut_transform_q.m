%UT_TRANSFORM_q  Perform unscented transform for state vector containing
%quaternions
%
% Modification of ut_transform. Kjartan Halvorsen 2012-03-20
% Syntax:
%   [mu,S,C,X,Y,w] = UT_TRANSFORM_Q(M,P,g,g_param,tr_param)
%
% In:
...
function [mu,S,C,X,Y,w] = ut_transform_q(M,P,g,g_param,tr_param)
